...
import com.degree.homedash.shared.model.device_metadata.SetpointPair
...
fun FanMetadata.Companion.dellaTowerFan(
    ...
    return FanMetadata(
        ...
        speedAdjustment = FanMetadata.SpeedAdjustment(
            12
        ),
 ...
 *
 * `heat_cool` is deliberately left out of [com.degree.homedash.shared.model.device_metadata.ThermostatMetadata.hvacModes] even though the hardware
 ...
 * [com.degree.homedash.shared.model.device_metadata.ThermostatMetadata.fanModes] brings the row back with no other change.
 */
fun ThermostatMetadata.Companion.livingRoomThermostat(
    ...
    return ThermostatMetadata(
        entityId = entityId,
        displayName = displayName,
        targetTemperature = ThermostatMetadata.TargetTemperature(
            min = 50.0,
            max = 90.0,
            step = 1.0
        ),
        ...
        extremeToggle = ThermostatMetadata.ExtremeToggle(
            "input_boolean.extreme_temperatures"
        ),
    )
}
