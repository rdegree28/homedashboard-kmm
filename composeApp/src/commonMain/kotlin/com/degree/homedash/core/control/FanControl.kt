...
import com.degree.homedash.core.util.previewFanDevice
 ...
 *  - **1-wide** (off / single-speed / offline): a plain [DeviceToggleCard] — spinning icon top-left,
...
private fun FanControlPreview() = ControlPreview {
    // On + multi-level is the 2-wide shape: shown full width, as the grid packs it.
    FanControl(
        previewFanDevice("With speed", isOn = true, percentage = 75, levelCount = 12),
        {},
        {},
        {},
        {})
    // The oscillation and mist pills only appear on the wide card, and only for fans that offer them.
    FanControl(
        previewFanDevice(
            "Oscillating",
            isOn = true,
    ...
    // Off collapses to the 1-wide toggle tile.
    Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
        FanControl(previewFanDevice("Off", levelCount = 12), {}, {}, {}, {}, Modifier.weight(1f))
        FanControl(previewFanDevice("Offline", offline = true), {}, {}, {}, {}, Modifier.weight(1f))
    }
}
